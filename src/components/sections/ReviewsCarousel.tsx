    ...
    <section className="py-16 lg:py-24 bg-cream-200">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="relative">
          <button
            onClick={() => scroll("left")}
            className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 z-10 w-9 h-9 bg-white border border-cream-300 flex items-center justify-center hover:bg-cream-100 hover:border-orange-400 transition-colors hidden md:flex shadow-sm"
          ...
          <button
            ...
            className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-4 z-10 w-9 h-9 bg-white border border-cream-300 flex items-center justify-center hover:bg-cream-100 hover:border-orange-400 transition-colors hidden md:flex shadow-sm"
