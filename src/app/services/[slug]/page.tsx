...
export async function generateMetadata({
  ...
  return {
    ...
    description: `Professional ${service.title.toLowerCase()} in ${siteConfig.region}. ${service.shortDescription} Call ${siteConfig.phone} for a free quote.`,
  };
}
    ...
    <>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <p className="text-gray-600 mb-6">
                Don&apos;t wait until a small problem becomes a major emergency. Watch for these warning signs
                and call us at the first indication of trouble.
              </p>
            ...
            <div className="bg-gradient-to-br from-navy-100 to-navy-200 rounded-2xl overflow-hidden aspect-[4/3] flex items-center justify-center">
              <div className="text-center p-8">
                <p className="text-navy-600 font-medium">Service Photo</p>
                <p className="text-navy-500 text-sm mt-1">{service.title} in progress</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 lg:py-24">
        <div className="max-w-4xl mx-auto px-4">
          <div className="text-center mb-12">
            <SectionLogo />
            <h2 className="text-3xl font-bold text-navy-800 mb-4">Our {service.title} Process</h2>
          ...
          <div className="space-y-6">
            {[
              { step: 1, title: "Contact Us", desc: "Call us or fill out our online form to describe your issue. We'll schedule a convenient time to visit." },
              { step: 2, title: "Inspection & Diagnosis", desc: "Our licensed plumber arrives on time, inspects the issue, and provides an upfront, transparent quote." },
              { step: 3, title: "Professional Service", desc: "Once you approve, we complete the work using high-quality materials and proven techniques." },
              { step: 4, title: "Final Walkthrough", desc: "We walk you through everything we did, answer your questions, and leave the area clean." },
            ].map((item) => (
      ...
      <section className="py-16 lg:py-24">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-gray-600 mb-8">
            Call us today for a free, no-obligation quote. Our licensed plumbers are ready to help.
          </p>
